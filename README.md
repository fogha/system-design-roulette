...
Every class starts where you already are. Choose the foundations, declare a starting stage with familiar topics, or take a short diagnostic drawn from the course's entry bank. The result is a path revision: an accepted entry point, the earlier material you can revisit, the refreshers upcoming work depends on, and the required outcome that remains. Declared familiarity and diagnostic samples never award completion, mastery or a streak.
